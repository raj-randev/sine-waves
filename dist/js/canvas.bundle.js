...
function animate() {
  ...
  c.fillStyle = "rgba(".concat(background.r, ", ").concat(background.g, ", ").concat(background.b, ", ").concat(background.a, ")");
  ...
  c.strokeStyle = "hsl(".concat(strokeColor.h * Math.sin(increment), ", ").concat(strokeColor.s, "%, ").concat(strokeColor.l, "%)");
  c.stroke();
